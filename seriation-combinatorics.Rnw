...
secs_per_trial <- 0.005  # 5 milliseconds per trial
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
<<subsets-graph,echo=FALSE,message=FALSE,warning=FALSE,out.width='3.5in',fig.pos='h!',fig.lp='fig:',fig.cap='Number of Unique Solution Sets for 40 Assemblages When Partitioned Into $m$ Solution Groups'>>=
...
u + geom_bar(stat="identity", fill = 'white', color = 'black') + scale_x_continuous(name = "Number of Subsets", limits=c(0,assem+1)) + scale_y_log10(name = y_caption) + theme_pander()
@
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
